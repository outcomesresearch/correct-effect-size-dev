...
export const TWO_GROUPS_EFFECT_SIZES = "two-groups-effect-sizes-cat";
...
export const PAIRWISE_EFFECT_SIZES = "pairwise-effect-sizes-cat";
export const OVERALL_EFFECT_SIZES = "overall-effect-sizes-cat";
...
// Regression flow
export const REGRESSION_MODEL = "regression-model-cat";
...
export const REGRESSION_OVERALL_EFFECT_SIZES =
  "regression-overall-effect-sizes-cat";
