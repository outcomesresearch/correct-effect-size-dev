...
export default function CStatistic() {
  return (
    <Stack gap="lg">
      <Stack gap={4}>
        <Text>
        ...
        <List spacing={2}>
          <List.Item>
            <Text>
              ...
              This indicates strong predictive accuracy and suggests that the
              model has a high probability of correctly ranking pairs of subjects
              in order of their event times.
            </Text>
          </List.Item>
          <List.Item>
            <Text>
              ...
              This implies that the model has no better discriminatory power than
              random chance.
            </Text>
          </List.Item>
          <List.Item>
            <Text>
              ...
              This suggests that the model consistently predicts in the opposite
              direction, thus implying poor predictive accuracy.
            </Text>
          </List.Item>
        </List>
      </Stack>
        ...
        <List spacing={2}>
          <List.Item>
            <Text>
              ...
              Random performance or no discrimination (equivalent to flipping a
              coin)
            </Text>
          </List.Item>
          <List.Item>
            <Text>
              ...
              Acceptable discrimination, suggesting some ability to distinguish
              between event and nonevent cases
            </Text>
          </List.Item>
          <List.Item>
            <Text>
              ...
              Good discrimination, indicating a strong ability to distinguish
              between event and nonevent cases
            </Text>
          </List.Item>
          <List.Item>
            <Text>
              ...
              Excellent discrimination, suggesting a near-perfect ability to
              discriminate between event and nonevent cases
            </Text>
          </List.Item>
        </List>
      </Stack>
