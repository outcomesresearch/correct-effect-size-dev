...
export default function PointBiSerialCorrelation() {
  return (
    <Stack gap="lg">
      <Stack gap={4}>
        <Text>
          ...
          relationship between two variables when one is continuous and the other
          is binary in nature. This measure is a special case of the Pearson
      ...
      <Stack gap={6}>
        ...
        <List spacing={2}>
          <List.Item>
            <Text>
              <Text span fw={500}>
                Positive r_pb (0 to +1):
              </Text>{" "}
              This indicates a positive association between the variables. As the
              values of the continuous variable increase, the likelihood of the
              dichotomous variable taking a particular value (e.g., 1) also tends
              to increase.
            </Text>
          </List.Item>
          <List.Item>
          ...
          <List.Item>
            <Text>
              <Text span fw={500}>
                Negative r_pb (0 to -1):
              </Text>{" "}
              This indicates a negative association between the variables. As the
              values of the continuous variable increase, the likelihood of the
              dichotomous variable taking a particular value (e.g., 1) tends to
              decrease.
            </Text>
          </List.Item>
        </List>
      ...
      <Stack gap={6}>
        <Stack gap={0}>
          <Text fw={500}>
            Interpreting the magnitude of point-biserial correlation
          </Text>
          <Text>
