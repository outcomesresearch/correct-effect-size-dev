...
function Example1() {
  return (
    <Stack gap="md">
      <Text fs={"italic"} mt={0}>
        Is there a difference in mean hemoglobin value after 6 weeks of therapy
        between adult patients with end-stage kidney disease and anemia who
        receive epoetin alfa or darbepoetin alfa?
      </Text>
        ...
        <Tabs.Panel value="studyDesign" pt="md">
          <Stack gap="md">
            ...
            <Stack gap={0}>
              ...
              <Text>
                The study population consists of 30 adult patients with
            ...
            <Stack gap={0}>
              ...
              <Stack gap={0}>
                ...
                <Text>
                  ...
                  administration of two different erythropoietin-stimulating
                  agents (ESA) protocols - epoetin alfa (n=15) and darbepoetin
                  alfa (n=15).
                </Text>
              </Stack>
              <Stack gap={0}>
        ...
        <Tabs.Panel value="effectSize" pt="md">
          <Stack gap="md">
            <Stack gap={0}>
              ...
              <Text>
                Hedge&apos;s g will be used as the effect size measure to
                demonstrate the magnitude of the difference in hemoglobin value
            ...
            <Stack gap={0}>
              ...
              <Text>
                The minimal clinically important difference (MCID) was not
        ...
        <Tabs.Panel value="result" pt="md">
          <Stack gap="md">
            <Stack gap={0}>
              ...
              <Text>
                The mean pre-study hemoglobin value for the 30 participants is
                8.6 g/dl. The post-intervention mean (±SD) hemoglobin value for
                the epoetin alfa group is 10.0 (1.1) g/dL, while for the
                darbepoetin alfa group it is 10.3 (1.2) g/dL, for a difference
                (95% CI) of 0.3 g/dL (-0.56 to 1.2)
              </Text>
              <Text>
                The Hedge&apos;s{" "}
                <Text span fs="italic">
            ...
            <Stack gap={0}>
              ...
              <Text>
                The 95% confidence interval for Hedge&apos;s{" "}
                <Text span fs="italic">
                  g
                </Text>{" "}
                is narrow, ranging from 0.05 to 0.45.
              </Text>
            </Stack>
            <Stack gap={0}>
              <Text fw={500}>
        ...
        <Tabs.Panel value="discussion" pt="md">
          <Stack gap="md">
            <Stack gap={0}>
              ...
              <Text>
                The difference in hemoglobin is only 0.3 g/dL, which is small in
                favor of darbepoetin alfa. However, the confidence interval is
                wide, and the probability value (
                <Text span fs="italic">
                  p
                </Text>
                -value) is 0.48. Thus, the results are imprecise and neither
            ...
            <Text>
              ...
              value of 0.25, indicates a small effect size and the upper bound
              of the confidence interval suggest the largest effect consistent
              with the study results (0.45) is barely large enough to be
              considered a medium effect.
            </Text>
            <Text>
              The results of the study suggest that there is a small difference
              in mean hemoglobin value after 6 weeks of therapy between patients
              receiving epoetin alfa and darbepoetin alfa but the difference is
              neither statistically nor clinically meaningful.
            </Text>
              ...
              <List spacing="xs">
                <List.Item>
                  <Text>
                    ...
                    To minimize variability and enhance precision, standardize
                    measurements through methods such as a Standard Operating
                    Procedure (SOP) manual, validated assessments, and
                    calibrated instruments, as seen in the measurement of
                    hemoglobin. Additionally, evaluate the sensitivity and
                    specificity of these measurement tools to ensure they can
                    detect small but clinically significant changes. While
                    promoting consistency is crucial, it&apos;s equally
                    important to consider potential limitations of
                ...
                <List.Item>
                  <Text>
                    ...
                    availability, can limit the ability to significantly expand
...
Example1.title =
  "A Randomized Clinical Trial Comparing the Efficacy of Epoetin Alfa and Darbepoetin Alfa in Adult Patients with End-Stage Kidney Disease and Anemia";
