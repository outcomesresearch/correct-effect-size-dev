...
export default function HedgesGTabs() {
  const explanationSections = [
    <Stack gap={4}>
      <Text>
        Hedge&apos;s <Text span fs="italic">g</Text> is a standardized measure that represents the magnitude of
        the difference between two groups in terms of standard deviations, similar
        to Cohen&apos;s <Text span fs="italic">d</Text> and Glass&apos;s ∆. The difference is its incorporated
    ...
    <Stack gap={6}>
      <Stack gap={0}>
        <Text fw={500}>Interpreting the magnitude of Hedge&apos;s <Text span fs="italic">g</Text></Text>
        <Text>
          The interpretation of Hedge&apos;s <Text span fs="italic">g</Text> as an absolute value is as follows:
        </Text>
      </Stack>
      <List spacing={2}>
        <List.Item>
    ...
    <Stack gap={0}>
      <Text fw={500}>When to use Hedge&apos;s <Text span fs="italic">g</Text></Text>
      <Text>
        Hedge&apos;s <Text span fs="italic">g</Text> is particularly useful when dealing with small sample sizes
