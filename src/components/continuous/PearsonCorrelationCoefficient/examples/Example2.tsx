        ...
        <Tabs.Panel value="effectSize" pt="md">
          <Stack gap="md">
            <Stack gap={0}>
              ...
              <Text>
                The Pearson correlation coefficient (<Text span fs="italic">r</Text>) is calculated to measure the strength and direction of the association between nightly sleep duration and cognitive performance. The 95% confidence interval (CI) is reported to indicate the precision of the estimates.
              </Text>
            </Stack>
            <Stack gap={0}>
              <Text fw={500}>
        ...
        <Tabs.Panel value="result" pt="md">
          <Stack gap="md">
            <Stack gap={0}>
              ...
              <Text>
                Pearson Correlation Coefficient (<Text span fs="italic">r</Text>) between Sleep Duration and Cognitive Performance = 0.62
              </Text>
            </Stack>
            <Stack gap={0}>
            ...
            <Stack gap={0}>
              ...
              <Text><Text span fs="italic">p</Text> = 0.4</Text>
            </Stack>
          </Stack>
        </Tabs.Panel>
        ...
        <Tabs.Panel value="discussion" pt="md">
          <Stack gap="md">
            <Stack gap={0}>
              ...
              <Text>
                Using the interpretation guide, the Pearson correlation coefficient (<Text span fs="italic">r</Text>) of 0.62 indicates a moderate to strong positive correlation between nightly sleep duration and cognitive performance in older adults – longer sleep duration is associated with increased mental performance.
              </Text>
            </Stack>
            <Text>
              The researchers can conclude with 95% confidence that the actual value for the correlation coefficient (<Text span fs="italic">r</Text>) between nightly sleep duration and cognitive performance in older adults in the population could range from 0.32 (weak association) to 0.92 (very strong association). In this case, the 95% confidence interval (CI) around the correlation coefficient is considered imprecise because the range includes values indicating weak, moderate, strong, and very strong associations. Thus, this study provides limited evidence about the true strength of the relationship.
            </Text>
            <Text>
              The probability value (<Text span fs="italic">p</Text>-value) of 0.4 indicates that the likelihood of obtaining a Pearson correlation coefficient (<Text span fs="italic">r</Text>) of 0.62 or greater by chance alone, assuming there is no relationship between these two variables, is relatively high. Therefore, the investigators cannot reject the null hypothesis of no relationship. The strength of the association, as indicated by the correlation coefficient, should be considered more closely than the <Text span fs="italic">p</Text>-value alone to understand the practical significance of the results.
            </Text>
