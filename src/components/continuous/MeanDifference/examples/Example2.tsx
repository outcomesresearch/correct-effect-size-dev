        ...
        <Tabs.Panel value="result" pt="md">
          <Stack gap="md">
            <Stack gap={0}>
              ...
              <Text>
                The post-intervention mean (±SD) HADS-A score for the 125 adults who were randomized to MBSR was 6.5 (±4), while the mean (±SD) HADS-A score for the 125 adults randomized to relaxation-based therapy was 11.0 (±6), resulting in a mean difference of 4.5.
              </Text>
            </Stack>
            <Stack gap={0}>
        ...
        <Tabs.Panel value="discussion" pt="md">
          <Stack gap="md">
            <Stack gap={0}>
              ...
              <Text>
                The mean difference of 4.5 points in the HADS-A between the two intervention arms suggests a clinically important difference.
              </Text>
            </Stack>
            <Text>
              Although the confidence interval is relatively narrow, it is not considered precise because it includes both clinically meaningful and clinically meaningless results. The lower bound of the 95% CI is 3.2, which is smaller than the MCID for HADS-A (4.0), indicating that not all plausible differences in the population would be clinically important.
            </Text>
            <Text>
              The probability value (<Text span fs="italic">p</Text>-value) is &lt;0.001, making the results statistically significant. However, despite this statistical significance, the imprecision around the clinically meaningful difference and the inclusion of clinically meaningless differences make the results of this study &quot;indeterminate.&quot;
            </Text>

            <Stack gap={0}>
              <Text fw={500}>Implication of Results</Text>
              <Text>
                Because the preponderance of the confidence interval is within the MCID effect size range, this study provides some evidence that MBSR is more effective at anxiety reduction than relaxation-based therapy. Still, no definitive conclusion can be made regarding whether the difference is clinically meaningful.
              </Text>
            </Stack>
            ...
            <Stack gap={0}>
              ...
              <List spacing="xs">
                ...
                <List.Item>
                  <Text>
                    The investigator can implement strategies to reduce systematic error, such as ensuring each intervention is provided in a standardized way and with true fidelity to establish practice.
                  </Text>
                </List.Item>
                <List.Item>
                  <Text>
                    Explore additional factors that may define unique prognostic subgroups for whom the chosen protocol is associated with better (or worse) anxiety reduction outcome.
                  </Text>
                </List.Item>
                <List.Item>
                  <Text>
...
Example2.title = "Comparative Efficacy of Mindfulness-Based Therapy versus Relaxation-Based Therapy in Symptom Reduction Among Adults with Generalized Anxiety Disorder: A Randomized Controlled Trial";
